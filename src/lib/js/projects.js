export let projects = [
	...
	{
		title: 'interacly',
		description: `A dynamic AI-powered chatbot app that offers a wealth of knowledge across diverse categories, including Books, Automotives, 
                      Technologies, Events, Movies, Sports, and more. Interacly AI allows users to have personalized, real-time conversations about
					  their favorite topics, providing instant insights, recommendations, and information. Whether you're exploring the latest tech
					  trends, movie releases,or sports updates, Interacly AI is your go-to source for a wide range of interests, all in one place.
